  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: `${siteConfig.url}/api/og?lang=de` },
        ...
        { name: 'twitter:image', content: `${siteConfig.url}/api/og?lang=de` },
      ...
      link: [
        ...
        // Fonts
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Caveat:wght@400;500;600;700&family=DM+Sans:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&family=Space+Grotesk:wght@400;500;600;700&display=swap' },
